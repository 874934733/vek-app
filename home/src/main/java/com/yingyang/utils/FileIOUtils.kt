...
object FileIOUtils {
     ...
     */
    fun writeFileFromIS(
        filePath: String?, inputStream: InputStream?, append: Boolean
    ): Boolean {
     ...
     */
    fun writeFileFromIS(
        file: File?, inputStream: InputStream?, append: Boolean
    ): Boolean {
     ...
     */
    fun writeFileFromIS(
        filePath: String?, inputStream: InputStream?, listener: OnProgressUpdateListener?
    ): Boolean {
     ...
     */
    fun writeFileFromIS(
        file: File?, inputStream: InputStream?, listener: OnProgressUpdateListener?
    ): Boolean {
     ...
     */
    fun writeFileFromIS(
        file: File?, inputStream: InputStream?, append: Boolean, listener: OnProgressUpdateListener?
    ): Boolean {
     ...
     */
    fun readFile2BytesByStream(
        file: File?, listener: OnProgressUpdateListener?
    ): ByteArray? {

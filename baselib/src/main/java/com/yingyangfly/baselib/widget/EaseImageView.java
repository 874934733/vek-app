...
public class EaseImageView extends AppCompatImageView {
    ...
    public EaseImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        super.setScaleType(SCALE_TYPE);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.EaseImageView, defStyle, 0);
        mBorderWidth = a.getDimensionPixelSize(R.styleable.EaseImageView_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.EaseImageView_border_color, DEFAULT_BORDER_COLOR);
        a.recycle();
        mReady = true;
